...
class FraudDetectionError(Exception):
    ...
    def __init__(
        self, message: str, context: dict[str, Any] | None = None, error_code: str | None = None
    ):
...
class DeviceFingerprintError(FraudDetectionError):
    ...
    def __init__(
        ...
        partial_attributes: dict[str, Any] | None = None,
    ):
...
class ConfigurationError(FraudDetectionError):
    ...
    def __init__(
        self, message: str, context: dict[str, Any] | None = None, config_key: str | None = None
    ):
...
class ServiceUnavailableError(FraudDetectionError):
    ...
    def __init__(
        self, message: str, context: dict[str, Any] | None = None, service_name: str | None = None
    ):
...
def handle_error(
    error: Exception, context: dict[str, Any], reraise: bool = True, log_level: int = logging.ERROR
) -> None:
    """
...
def log_and_raise(
    ...
    **kwargs,
    ...
    logger.error(
        ...
        extra={"error_details": error.to_dict(), **kwargs},
        exc_info=True,
    )
...
def error_boundary(
    fallback_value: Any = None, exceptions: tuple = (Exception,), log_level: int = logging.ERROR
):
    """
